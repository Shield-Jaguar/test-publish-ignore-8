...
**_Note:_** Documentation for the client can be found [here.](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/client.md)
...
* [Simple Calculator](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/controllers/simple-calculator.md)

## Classes Documentation

* [Utility Classes](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/utility-classes.md)
* [HttpRequest](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-request.md)
* [HttpResponse](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-response.md)
* [HttpStringResponse](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-string-response.md)
* [HttpContext](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-context.md)
* [HttpClientConfiguration](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-client-configuration.md)
* [HttpClientConfiguration Builder](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/http-client-configuration-builder.md)
* [IAuthManager](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/i-auth-manager.md)
* [ApiException](https://www.github.com/Shield-Jaguar/test-publish-ignore-8/tree/1.2.3/doc/api-exception.md)
